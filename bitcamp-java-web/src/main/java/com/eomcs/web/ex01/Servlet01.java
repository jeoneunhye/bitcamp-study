...
// => WEB-INF/web.xml
// => DD File(Deployment Descriptor)
// => 배치 예:
// <servlet>
//   <servlet-name>등록할서블릿별명</servlet-name>
//   <servlet-class>서블릿 클래스의 패키지명을 포함한 경로</servlet-class>
// </servlet>
...
// => 클라이언트마다 구분되어야 할 데이터는 서블릿 인스턴스 변수에 보관해서는 안 된다.
