...
//    - 서블릿 컨테이너를 시작하거나 종료할 때 보고받고 싶다면 이 인터페이스를 구현하라.
// => ServletRequestListener
//    - 요청이 들어오거나 종료될 때 보고받고 싶다면 이 인터페이스를 구현하라.
// => HttpSessionListener
//    - 세션이 생성되거나 종료될 때 보고받고 싶다면 이 인터페이스를 구현하라.
// => XxxListener
...
// => ServletContextListener
//    - 웹 애플리케이션을 시작할 때 Spring IoC Container 준비하기
//    - 웹 애플리케이션을 시작할 때 DB Connection Pool 준비하기
//    - 웹 애플리케이션을 종료할 때 DB Connection Pool에 들어 있는 모든 연결을 해제하기
// => ServletRequestListener
//    - 요청이 들어올 때 로그 남기기
