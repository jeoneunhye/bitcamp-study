...
public class Servlet21 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 테스트 방법:
    // http://localhost:9999/bitcamp-java-web/ex10/s21
    ...
    /*
          ...
          Set-Cookie: v2=bbb; Path=/bitcamp-java-web/ex10/a  <--- 사용 범위가 /bitcamp-java-web/ex10/a로 제한되었다.
          Set-Cookie: v3=ccc; Path=/bitcamp-java-web
          Content-Type: text/plain;charset=UTF-8
          Content-Length: 36
          Date: Wed, 08 Apr 2020 02:51:25 GMT
