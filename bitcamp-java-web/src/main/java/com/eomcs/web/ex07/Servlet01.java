...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 테스트 방법:
    // http://localhost:9999/bitcamp-java-web/ex07/s1?a=100&b=200&op=+
    // http://localhost:9999/bitcamp-java-web/ex07/s1?a=100&b=200&op=-
    // http://localhost:9999/bitcamp-java-web/ex07/s1?a=100&b=200&op=*
    ...
    // => + 연산자를 파라미터 값으로 보내고 싶다면 URL 인코딩해야 한다.
    // => 왜? + 문자는 URL에서 한 칸의 공백을 의미한다.
    //    즉 getParamter("op")의 리턴 값이 공백(" ")이다.
    // => + 문자의 URL 인코딩 값은?
    //       %2b
    // => 따라서 + 연산을 파라미터 값으로 보내려면
    //    http://localhost:9999/bitcamp-java-web/ex07/s1?a=100&b=200&op=%2b
    ...
    out.printf("%d + %d = %d\n", a, b, (a + b)); // return을 주석처리하면 해당 코드가 실행되지 않는다.
  }
}