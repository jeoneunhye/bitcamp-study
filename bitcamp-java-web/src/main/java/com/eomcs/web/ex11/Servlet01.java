...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 테스트 방법:
    // http://localhost:9999/bitcamp-java-web/ex11/s1
    ...
    /*
          HTTP/1.1 200
          Set-Cookie: JSESSIONID=47D4FABBFD28BBD64D9DDA06909AC7DB; Path=/bitcamp-java-web; HttpOnly
          Content-Type: text/plain;charset=UTF-8
          Content-Length: 45
          Date: Wed, 08 Apr 2020 03:11:27 GMT
