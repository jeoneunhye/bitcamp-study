...
public class Servlet01 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // 테스트
    // http://localhost:9999/bitcamp-java-web/ex05/test01.html 실행

    // HTTP 프로토콜로 통신을 하는 서블릿 컨테이너는
    // service() 메서드를 호출할 때
    // ServletRequest의 값으로 HttpServletRequest를 만들어 전달한다.
    // ServletResponse의 값으로 HttpServletResponse를 만들어 전달한다.
