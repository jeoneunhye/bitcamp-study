...
// 멀티파트 형식으로 전송된 데이터는
// 별도의 처리 과정이 필요하다.
// 이 일을 대신 해 주는 라이브러리가 있다.
// => Apache 재단에서 제공하는 fileupload 라이브러리
@WebServlet("/ex04/s4")
public class Servlet04 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // 테스트
    // http://localhost:9999/bitcamp-java-web/ex04/test04.html 실행
    ...
    // 멀티파트 형식의 데이터 처리하기
    // 1) Apache 라이브러리 가져온다.
    //    - mvnrepository.com에서 apache fileupload 라이브러리를 검색한다.
    ...
    // => 공장 객체를 사용하여 클라이언트가 보낸 데이터를 처리할 객체를 준비한다.
    ...
    try {
      ...
      // tmp1/wtpwebapps/bitcamp-java-web/upload
...
/*
POST /bitcamp-java-web/ex04/s4 HTTP/1.1
Host: 192.168.1.44:9999
Content-Length: 7222
Pragma: no-cache
Cache-Control: no-cache
Origin: http://192.168.1.44:9999
...
Referer: http://192.168.1.44:9999/java-web/ex04/test04.html
