...
public class Exam01 {
  public static void main(String[] args) {
    ...
    //    mvnrepository.com 또는 search.maven.org에서 spring-context로 라이브러리를 검색한다.
    ...
    // => 스프링 IoC 컨테이너의 사용 규칙을 정의한 인터페이스다.
    ...
    // => 자바 CLASSPATH?
    //    예를 들면 /Users/user/git/bitcamp-study/bitcamp-java/bin/main
    ...
    ApplicationContext iocContainer = // <- 인터페이스이기 때문에 구현체를 생성해야 한다.
        new ClassPathXmlApplicationContext("com/eomcs/spring/ioc/ex01/a/application-context.xml");
    // 설정파일이 자바 클래스 경로에 있다면 ClassPathXmlApplicationContext 클래스를 사용한다.
