...
public class Exam0151 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s1.hashCode()); // 1678702170
    System.out.println(s2.hashCode()); // 1678702170
    System.out.println(s3.hashCode()); // 1566232583
    System.out.println(s4.hashCode()); // 1562779400
    System.out.println("--------------------");
