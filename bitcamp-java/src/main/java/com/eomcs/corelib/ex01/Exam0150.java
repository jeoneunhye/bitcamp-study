...
public class Exam0150 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s1.hashCode()); // 1831932724
    System.out.println(s2.hashCode()); // 1747585824
    System.out.println(s3.hashCode()); // 1023892928
    System.out.println(s4.hashCode()); // 558638686
    System.out.println("--------------------");
    ...
    // 해결책?
    // => Student 클래스에서 hashCode()를 오버라이딩하여
