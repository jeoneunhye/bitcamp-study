...
public class Exam43 {
  public static void main(String[] args) {
    System.out.println(0xac00); // 정수 리터럴 44032
    System.out.println((char)0xac00); // 문자 코드임을 가리킨다. 가 char 2바이트 리터럴
    ...
    // 문자 코드에 정수 값을 연산하는 순간 그 결과는 더 이상 문자 코드가 아니라
    // 일반적인 정수가 된다. -> println()은 그 값에 대한 문자를 출력하는 것이 아니라
    // 그냥 정수를 출력하는 것이다.
