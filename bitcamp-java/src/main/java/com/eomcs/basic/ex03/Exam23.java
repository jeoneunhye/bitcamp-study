...
public class Exam23 {
  public static void main(String[] args) {
    ...
    // 리터럴에 아무런 표시를 안 하면 기본이 4바이트 정수를 의미한다
     System.out.println(100); // jvm에서 4바이트 메모리에 저장(0~2의 32승-1개)

    System.out.println(-2147483648); // -2의 31승 : 4바이트 최소 음수
    System.out.println(2147483647); // 2**31 - 1 : 4바이트 최대

    //System.out.println(-2147483649);  // 4바이트 메모리 크기 초과
    //System.out.println(2147483648); // 오류 발생 : integer number too large

    // 8바이트 정수 리터럴 : 숫자 뒤에 접미사 L. 엘을 붙인다
