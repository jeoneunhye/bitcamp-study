...
public class Exam01_43 {
  public static void main(String[] args) {
    float f1 = 987.6543f;
    float f2 = 1.111111f;
    System.out.println(f1);  // 987.6543 OK
    System.out.println(f2);  // 1.111111 OK
    ...
    // 기대값: 988.765411 (987.6543 + 1.111111)
    // 결과가 옳지 않게 나온 이유?
    ...
    double d1 = 987.6543;
    double d2 = 1.111111;
    double r3 = d1 + d2; // 988.7654110000001
    System.out.println(r3);
    // 그럼에도 실제 출력해보면 맨 뒤에 극한의 작은 수가 붙는다.
    // 이유? IEEE 754 이진수 변환 문제이다. 고민하지 말라!
    // 어떻게 처리할 건데? 맨 뒤에 붙는 극한의 작은 수는 그냥 잘라 버린다.
  }
}
