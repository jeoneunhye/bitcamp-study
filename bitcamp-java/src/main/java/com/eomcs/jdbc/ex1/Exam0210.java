...
public class Exam0210 {
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      // jdbc url : DBMS 서버 정보 ex) jdbc:DBMS://서버주소:포트/데이터베이스명
      // (포트번호를 지정하지 않으면 기본이 3306)
      // username : DBMS 사용자 아이디
      // password : DBMS 사용자 암호
      con = DriverManager.getConnection( // Connection 인터페이스 구현체를 리턴
          "jdbc:mariadb://localhost:3306/studydb", // jdbcURL
          "study", // username
          "1111" // password
          // 잘못된 데이터베이스, 아이디, 암호를 입력하면 Access denied 오류가 발생
          );
