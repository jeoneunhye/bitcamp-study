...
public class Exam0310 {
  public static void main(String[] args) throws Exception {
    ...
    // 인스턴스의 필드 값만 출력하는 것이 아니다.
    // 인스턴스의 클래스 이름과 인스턴스 변수의 정보도 함께 출력한다.
    // 즉, 출력데이터 = 패키지이름을 포함한 클래스이름 + 인스턴스 변수 정보 + 인스턴스 변수 값
    // 파일 사이즈가 큰 단점이 있지만 메서드 호출만 하면 되니 간편하다.
    out.close();
...
// 용어 정리!
// - Serialize(marshalling, 직렬화)
//   : 객체(인스턴스) ===> 바이트 배열
// - DeSerialize(unmarshalling, 객체 복원)
//   : 바이트 배열 ===> 객체