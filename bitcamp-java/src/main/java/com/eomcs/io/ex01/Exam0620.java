...
public class Exam0620 {
  public static void main(String[] args) throws Exception {
    class JavaFilter implements FileFilter {
      @Override
      public boolean accept(File file) { // 파일 정보를 파라미터로 받는 accept()
        // 이 메서드는 listFiles() 메서드를 호출한다.
        // 지정한 폴더에 들어있는 파일이나 디렉토리를 찾을 때마다 호출한다.
        // 리턴 값은 찾은 파일 정보를 File[]에 포함시킬지 여부를 결정한다.
        // true면 배열에 포함시키고 false면 배열에서 제외한다.
