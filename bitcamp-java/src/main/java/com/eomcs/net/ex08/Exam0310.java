...
public class Exam0310 {
  public static void main(String[] args) throws Exception {
    ...
    // HttpClients, HttpGet 등 클래스
    // => www.apache.org 사이트에서 제공하는 HttpComponent 라이브러리에 들어있는 클래스다.
    ...
    if (entity != null) {
      ...
      System.out.printf("응답 데이터 크기 => %d\n",
          entity.getContentLength()); // 못 꺼내는 경우도 있다.
      ...
      // => 이 부분을 대신 해주는 도우미 클래스 EntityUtils가 있다.
