  ...
  public static void main(String[] args) throws Exception {
    ...
    while (true) {
      ...
      try (Socket socket = new Socket("localhost", 8888);
        ...
        // 서버에서 보낸 클라이언트 아이디와 계산 결과를 읽는다.
        clientId = in.readLong(); // client: out.writeLong(clientId);
        int result = in.readInt(); // client: out.writeInt(result);
