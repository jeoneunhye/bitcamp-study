...
public class Exam0120 {
  ...
  // 명확하게 제시해주는 것이 유지 보수에 도움이 되기 때문에
  ...
  static Board read() throws RuntimeException {
    try (Scanner keyScan = new Scanner(System.in)) {
      ...
      // Integer 클래스는 runtimeException을 상속받았다.
      ...
      // valueOf()는 runtimeException을 상속받았다.
  ...
  public static void main(String[] args) {
    try {
      ...
      System.out.println(e.getMessage()); // 오류 발생 내용
      System.out.println("게시물 입력 중에 오류 발생!");
      e.printStackTrace(); // 호출의 역순에 따라 예외 발생 내역 출력
    }
  }
}