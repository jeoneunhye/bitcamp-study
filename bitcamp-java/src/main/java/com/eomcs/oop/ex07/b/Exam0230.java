...
public class Exam0230 {
  public static void main(String[] args) {
    ...
    // => 생성자가 protected로 되어 있다. (Java API 11에 기술)
    // => 의미?
    //    - 보통 개발자가 클래스를 만들 때에는 자신만의 패키지에 넣어서 만든다.
    ...
    // getInstance()의 리턴 값을 확인해 보면 cal1과 cal2가 다르다는 것을 알 수 있다.
    // 즉 getInstance() 메서드는 singleton 기능을 수행하는 메서드가 아니라
    // 복잡한 Calendar 객체를 대신 생성해주는 factory method로서의 역할을 수행한다.
