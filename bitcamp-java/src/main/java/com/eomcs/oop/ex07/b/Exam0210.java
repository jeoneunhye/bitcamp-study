...
public class Exam0210 extends C {
  public static void main(String[] args) {
    ...
    //obj1.privateVar = 100; // 접근 불가! 오직 그 클래스 안의 멤버만이 접근 가능
    ...
    //obj2.privateVar = 100; // 접근 불가! 오직 그 클래스 안의 멤버만이 접근 가능
    ...
    //obj3.privateVar = 100; // 접근 불가! 오직 그 클래스 안의 멤버만이 접근 가능
    //obj3.defaultVar = 100; // 접근 불가! 같은 패키지까지만 접근 가능
    //obj3.protectedVar = 100; // 접근 불가! 같은 패키지 또는 자식 클래스 접근 가능
    // 자식 클래스인데 접근 불가?
    // 이유 => Exam0210 설계도가 아닌 C 설계도에 따라 만든 것이므로 자기의 인스턴스 변수가 아니다.
    obj2.publicVar = 100; // OK! 모두 다 접근 가능
