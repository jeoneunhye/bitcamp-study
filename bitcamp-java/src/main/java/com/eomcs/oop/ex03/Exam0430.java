...
public class Exam0430 {
  ...
  public static void main(String[] args) {
    ...
    Score s1 = new Score(); // default 생성자
    // ★인스턴스 생성 후에 나중에 따로 생성자를 호출할 수 없다!
    //s1.Score("홍길동", 100, 90, 77); // 컴파일 오류!
    Score s2 = new Score("유관순");    // 문자열을 받는 생성자
    Score s3 = new Score("홍길동", 100, 90, 77);   // 문자열, 숫자를 받는 생성자
    //Score s4 = new Score(true); // 논리값을 받는 생성자는 없다.
