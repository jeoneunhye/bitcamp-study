...
public class Exam0210 {
  ...
  public static void main(String[] args) {
    ...
    // 자바 컴파일러는 레퍼런스의 클래스를 보고 사용할 수 있는 변수/메서드인지 아닌지 
    // 판단한다. 비록 v1 변수에 Sedan 객체의 주소가 들어있다 할지라도,
    // 실제 들어있는 객체의 주소로 판단하지 않고 레퍼런스가 어떤 클래스냐에 따라 판단한다.
    /*
        v1.cc = 1980; // 컴파일 오류! Car의 인스턴스 변수
        v1.valve = 16; // 컴파일 오류! Car의 인스턴스 변수
        v1.sunroof = true; // 컴파일 오류! Sedan의 인스턴스 변수
        v1.auto = true; // 컴파일 오류! Sedan의 인스턴스 변수
     */
