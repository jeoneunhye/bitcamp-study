    ...
    try {
      ...
      while (true) {
        try {
          ...
          // 별도의 메서드로 분리
          // Lesson 클래스의 스태틱 메서드 valueOf(String)로 분리하여
          // 파일을 읽어 한 줄을 받아 객체로 만들고 그 객체를 리턴하도록 구현한다.
          /*
          ...
          lessonList.add(Lesson.valueOf(line)/*lesson*/);
          count++;
  ...
  private static void saveLessonData() {
    ...
    try {
      ...
      for (Lesson lesson : lessonList) {
        // 별도의 메서드로 분리
        // Lesson 클래스의 인스턴스 메서드 toCsvString()으로 분리하여
        // lesson 객체를 CSV 형식의 문자열 한 줄에 담아 리턴하도록 구현한다.
        /*
        ...
        out.write(lesson.toCsvString()/*line*/);
        count++;
      }
    ...
    try {
      ...
      while (true) {
        try {
          ...
          // 별도의 메서드로 분리
          // Member 클래스의 스태틱 메서드 valueOf(String)로 분리하여
          // 파일을 읽어 한 줄을 받아 객체로 만들고 그 객체를 리턴하도록 구현한다.
          /*
          String[] data = line.split(",");
          ...
          memberList.add(Member.valueOf(line)/*member*/);
          count++;
  ...
  private static void saveMemberData() {
    ...
    try {
      ...
      for (Member member : memberList) {
        // 별도의 메서드로 분리
        // Member 클래스의 인스턴스 메서드 toCsvString()으로 분리하여
        // member 객체를 CSV 형식의 문자열 한 줄에 담아 리턴하도록 구현한다.
        /*
        ...
        out.write(member.toCsvString()/*line*/);
        count++;
      }
    ...
    try {
      ...
      while (true) {
        try {
          ...
          // 별도의 메서드로 분리
          // Board 클래스의 스태틱 메서드 valueOf(String)로 분리하여
          // 파일을 읽어 한 줄을 받아 객체로 만들고 그 객체를 리턴하도록 구현한다.
          /*
          String[] data = line.split(",");
          ...
          boardList.add(Board.valueOf(line)/*board*/);
          count++;
  ...
  private static void saveBoardData() {
    ...
    try {
      ...
      for (Board board : boardList) {
        // 별도의 메서드로 분리
        // Board 클래스의 인스턴스 메서드 toCsvString()으로 분리하여
        // board 객체를 CSV 형식의 문자열 한 줄에 담아 리턴하도록 구현한다.
        /*
        ...
        out.write(board.toCsvString()/*line*/);
        count++;
      }
